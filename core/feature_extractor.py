...
class TaskFeatureExtractor:
    ...
    def extract_features(self, incoming_task):
        ...
        extracted = self._enforce_constraints(extracted, input_size, history_relevant, task_category)
    ...
    def _enforce_constraints(self, metrics, input_size, history, task_category):
        ...
        # Compute/Media tasks usually need more overhead.
        min_mem_ratio = 0.8 if task_category in ['compute', 'media'] else 0.4
        metrics['memory_usage_mb'] = max(input_size * min_mem_ratio, metrics['memory_usage_mb'])
